...
<input type=hidden name="refe" value="/form_make/form.php?it=740&pt=flosmarketing">
<input type="hidden" name="sub_url" id="url" value="https://marketclub.cafe24.com/form_make/form.php?it=740&pt=flosmarketing">
            <input type="hidden" name="user_agent" id="user_agent" value="">
				...
				<div class="detfm2" style="padding:20px;">
					...
					<div class="fmfrm">
						...
						<div style="margin-top: 10px;"><input type="text" placeholder="문의사항을 적어주세요" name="문의사항" >
						</div>
		<div class="main_global blank_hidden">
			<ul>
<input type="checkbox" type="checkbox" name="all_chk"checked  required/>
<label for="id_1_input_check_policy3">개인정보 수집이용동의</label>
				<a href="#" onclick="On_off_layer(&#39;policy3_1&#39;);return false;" class="Color_Box">[보기]</a></li>
			</ul>
		</div>
		<div id="policy3_1" class="main_policy" style="display: none;">
<textarea class="textarea_style" readonly="">
① 개인정보를 제공받는 자 : 한국국가고시센터
② 개인정보를 제공받는 자의 개인정보 이용 목적 : 고객상담
③ 제공하는 개인정보의 항목 : 고객상담
④ 개인정보를 제공받는 자의 개인정보 보유 및 이용 기간 : 상담완료시까지
 </textarea>
		</div>
